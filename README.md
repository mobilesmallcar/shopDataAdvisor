...
| 服务            | 默认地址                  | 说明                       | 图标  |
|:--------------|:----------------------|:-------------------------|:----|
| MySQL (meta)  | `192.168.10.131:3306` | 元数据库，存储表/字段定义            | 🗄️ |
| MySQL (dw)    | `192.168.10.131:3306` | 数据仓库，业务查询目标库             | 📦  |
| Qdrant        | `192.168.10.131:6333` | 字段和指标的向量索引               | 📐  |
| Elasticsearch | `192.168.10.131:9200` | 字段值的全文索引                 | 🔎  |
